...
rule all:
    input:
        ...
        fastqc_forward_pos = ["results/" + sample + "/fastqc/fastqc_pos/" + sample + "_1_fastqc.html" for sample in config["samples"]],
        fastqc_revers_pos = ["results/" + sample + "/fastqc/fastqc_pos/" + sample + "_2_fastqc.html" for sample in config["samples"]],
