...
rule all:
    input:
        ...
        fastqc_forward_pos = ["results/" + sample + "/fastqc/fastqc_pos/" + sample + "_forward_paired_fastqc.html" for sample in config["samples"]],
        fastqc_revers_pos = ["results/" + sample + "/fastqc/fastqc_pos/" + sample + "_reverse_paired_fastqc.html" for sample in config["samples"]],
...
rule fastqc_pos:
    ...
    output:
        forward = "results/{sample}/fastqc/fastqc_pos/{sample}_forward_paired_fastqc.html",
        revers = "results/{sample}/fastqc/fastqc_pos/{sample}_reverse_paired_fastqc.html"
    log:
